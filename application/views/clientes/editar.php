	...
	<div class="content-box-content">
		...
		<form action="<?php echo site_url('clientes/editar/' . $client['id_cliente']); ?>" method="post">
			...
			<p>
				...
				<input class="text-input small-input" value="<?php echo set_value('num_int', $client['numero_interior']); ?>" type="text" name="num_int" />
			...
			<p>
				...
				$ <input class="text-input small-input" value="<?php echo set_value('lim_credito', $client['limite_credito']); ?>" type="text" name="lim_credito" />
				<?php echo form_error('lim_credito'); ?>
			</p>
			
			<p>
				<label>Días de crédito *</label>
				<input class="text-input small-input" value="<?php echo set_value('dias_credito', $client['dias_credito']); ?>" type="text" name="dias_credito" />
