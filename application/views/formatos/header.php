...
<script type="text/php">
	if (isset($pdf)) {
		...
		$pdf->page_text(500, 35, '<?php echo $folio; ?>', $font, 9, array(0,0,0));
		$pdf->page_text(500, 50, 'Fecha: ' . date('d/m/Y'), $font, 9, array(0,0,0));
		$pdf->page_text(500, 65, 'Hora: ' . date('H:i'), $font, 9, array(0,0,0));
		$pdf->page_text(500, 80, utf8_encode('Página {PAGE_NUM}/{PAGE_COUNT}'), $font, 9, array(0,0,0));
	}
</script>