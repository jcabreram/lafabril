...
class Pagos extends CI_Controller
{
	...
	public function listar()
	{
		...
		// Get orders
		$data['paymentsData'] = $this->payments->getAll($filters);
		...
		$this->load->view('pagos/filterForm', $data);
		$this->load->view('footer', $data);
	}
	...
	public function filtrar()
	{
		if ($_POST) {
			...
			if (count($filters) > 0) {
				redirect('pagos/listar/' . $this->uri->assoc_to_uri($filters));
			} else {
				redirect('pagos');
			}
		}
	...
	public function exportar()
	{
		...
		$payments = $this->payments->getAll($filters);
		...
		$html .= $this->load->view('reportes/pagos', $data, true);
