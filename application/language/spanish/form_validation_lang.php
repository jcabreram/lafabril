...
$lang['valid_emails']		= "El campo %s debe contener todos los correos electrónicos válidos.";
...
$lang['alpha_dash']			= "El campo %s sólo puede contener caracteres alfanuméricos, guiones y guiones bajos.";
$lang['numeric']			= "El campo %s sólo debe contener números.";
$lang['is_numeric']			= "El campo %s sólo debe contener caracteres numéricos.";
$lang['integer']			= "El campo %s sólo debe contener un número entero.";
...
$lang['is_natural_no_zero']	= "El campo %s debe contener un numero mayor a cero.";
$lang['decimal']			= "El campo %s debe contener un número decimal.";
$lang['less_than']			= "El campo %s debe contener un número menor a %s.";
$lang['greater_than']		= "El campo %s debe contener un número mayot a %s.";
